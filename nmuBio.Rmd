...
## I hear from you about collaborating
## We build [even more] skills in each other

---
class: inverse, center, middle
background-image: url("images/group_lookout.jpg")
background-size: contain

---
class: inverse, center, middle
background-image: url("images/trailer_loading.jpg")
background-size: contain
...
---
class: inverse, center, middle
background-image: url("images/sarahCanoe.jpg")
background-size: contain
...
---
class: inverse, center, middle
background-image: url("images/finnJumps.jpg")
background-size: contain
...
---
class: inverse, center, middle
background-image: url("images/vdep.jpg")
background-size: contain
...
---
class: inverse, center, middle
background-image: url("images/glacierSign.jpg")
background-size: contain
...
## Exploring state and transition models
## Communicating outside of acadamia
...
# LANDFIRE products:
## Fire, modeled past and mapped present (1999-2016 and continuing)
...
---
class: inverse, center, middle
background-image: url("images/sass.jpg")
background-size: contain
...
NMU students: Cole Bonino, Liz Armstrong, Cassie Begert, Myles Walimaa, Scott Benhart, Cassidy Downing, Erin Matula, Gavin White, Lea Kemle and Mary Kelly
