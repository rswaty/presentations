...
class: inverse, center, middle
background-image: url("images/stm.jpg")
background-size: contain
...
---
class: inverse, center, middle
background-image: url("images/cassieFire.jpg")
background-size: contain
...
class: inverse, center, middle
background-image: url("images/nh_oldgrowth.jpg")
background-size: contain
...
class: inverse, center, middle
background-image: url("images/driftVdep.jpg")
background-size: contain
