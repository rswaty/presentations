...
# The Numbers:
## Started in 1951 (formally recognized as a non-profit)
## > 5,000 employees, ~400 scientists
## All 50 states, working in 76 countries
## Protected (?) over 125,000,000 acres.  Started with 60 acre land purchase.
...
# Reduce or store 3 gigatons of C02 emissions yearly (6 million elephants worth)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width="80%"}
knitr::include_graphics("images/river.jpg")
```
...
# Why does TNC care? Priorizing-Evaluating-Funding
